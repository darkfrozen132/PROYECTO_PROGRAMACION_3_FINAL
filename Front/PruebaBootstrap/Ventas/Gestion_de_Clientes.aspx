...
<asp:Content ID="Content1" ContentPlaceHolderID="cphVentas_Gestion_Clientes" runat="server">
   ...
   <link href="/Content/gestion_clientes.css" rel="stylesheet" type="text/css" />
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-md-12 mb-3">
                ...
                <asp:TextBox ID="txtNombre" CssClass="form-control" runat="server" onkeypress="return !seIngresoNumero(event)"></asp:TextBox>
            </div>
            <div class="col-md-12 mb-3">
            ...
            <div class="col-md-12 mb-3">
                ...
                <asp:TextBox ID="txtTelefono" CssClass="form-control"
                    runat="server" onkeypress="return seIngresoNumero(event)" MaxLength="9">
                </asp:TextBox>
            </div>
        </div>
    </div>
