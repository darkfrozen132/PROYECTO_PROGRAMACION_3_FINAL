...
public class DetallePedido {
    ...
    public DetallePedido(Pedido pedido, Producto producto, String codigo, Integer cantidad, double monto, String descripcion, Integer cantidad_por_entregar) {
        this.pedido = pedido;
    ...
    /**
     * @param producto the paquete to set
     */
